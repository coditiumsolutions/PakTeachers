  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-12">
      <div className="lms-fade-up lms-fade-up-1 mb-8">
        ...
        <h1 className="mt-3 text-2xl font-bold text-slate-900 sm:text-3xl">Profile & Settings</h1>
        <p className="mt-1 text-slate-500">Manage account details and preferences.</p>
      </div>
